            ...
            <?php else :
                foreach ($extractedUrls as $urlData) : ?>
                    <tr>
                        ...
                        <td>
                            <button class="nppp-purge-btn" data-file="<?php echo esc_attr($urlData['file_path']); ?>"><span class="dashicons dashicons-trash" style="font-size: 18px; margin: 0; padding: 0;"></span> <?php echo esc_html__( 'Purge', 'fastcgi-cache-purge-and-preload-nginx' ); ?></button>
                            <button class="nppp-preload-btn" data-url="<?php echo esc_attr($urlData['url']); ?>"><span class="dashicons dashicons-update" style="font-size: 18px; margin: 0; padding: 0;"></span> <?php echo esc_html__( 'Preload', 'fastcgi-cache-purge-and-preload-nginx' ); ?></button>
                        </td>
                    </tr>
                <?php endforeach;
            endif; ?>
